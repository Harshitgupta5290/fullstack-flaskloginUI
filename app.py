...
def reset():
    message = '' 
    if request.method == 'POST' and 'email' in request.form and 'password' in request.form and 'userid' in request.form:  
        email = request.form['email']
        #print (email)
        password = request.form['password']
        #print (password)
        if not password or not email:
            ...
            cursor = mysql.connection.cursor(MySQLdb.cursors.DictCursor)
            sqlupdate= """Update user SET password =%s where email =%s"""
